        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="lg:w-3/5 space-y-8 text-center lg:text-left">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-4 pt-4">
              <a
                href="#proceeds"
                className="inline-flex items-center gap-2.5 px-8 py-4 bg-amber-500 text-white font-extrabold text-lg rounded-xl hover:bg-amber-600 active:scale-[0.98] transition-all shadow-lg shadow-amber-500/25"
              >
                Donate
